...
//   // Officials: use allofficials if available
//   const officials = allOfficials.map(official => ({
//     fullname: official.fullname,
//     position: official.position,
//     photo: official.image[0] || `https://ui-avatars.com/api/?name=${encodeURIComponent(official.fullname)}&background=001F5B&color=fff&size=256`,
//     desc: official.bio || "Serving with dedication"
//   }));

//   // Members: users with a non-empty position field
//   const members = allUsers
//     .filter(user => user.position && user.position.trim() !== '')
//     .map(user => ({
//       fullname: user.fullname,
//       photo: user.image[0] || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.fullname)}&background=001F5B&color=fff&size=128`
//     }))
//     .sort((a, b) => a.fullname.localeCompare(b.fullname)); // alphabetical by fullname
...
//           {/* OFFICIALS SECTION – from allofficials */}
//           <section className="mb-24">
...
//                   <div 
//                     key={i} 
//                     className="bg-white rounded-3xl shadow-2xl p-8 text-center hover:shadow-3xl transition transform hover:-translate-y-4"
//                   >
//                     <img 
//                       src={official.photo} 
//                       alt={official.fullname}
//                       className="w-40 h-40 mx-auto rounded-full object-cover border-4 border-[#E30613] mb-6 shadow-xl"
//                       onError={(e) => e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(official.fullname)}&background=001F5B&color=fff&size=256`}
//                     />
//                     <h3 className="text-2xl font-bold text-[#001F5B] mb-2">{official.fullname}</h3>
//                     <p className="text-xl text-[#E30613] font-semibold mb-4">{official.position}</p>
...
//           {/* MEMBERS SECTION – filtered from allusers with position */}
...
//                       onError={(e) => e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(member.fullname)}&background=001F5B&color=fff&size=128`}
//                     />
