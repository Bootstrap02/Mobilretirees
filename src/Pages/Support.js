...
//             <h1 className="text-4xl md:text-3xl font-extrabold text-[#001F5B] mb-8">
//               We're Here to Help
//             </h1>
...
//             <h2 className="text-4xl md:text-3xl font-bold text-[#001F5B] text-center mb-16">
//               Send Us a Message
//             </h2>
...
const Support = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // 🚨 If not logged in
    if (!userData?._id) {
      alert('Please sign in first before contacting support.');
      return;
    }
    ...
    try {
      ...
      const { data } = await axios.post(
        'https://campusbuy-backend-nkmx.onrender.com/mobilcreatemessages/usercreatemessage',
        {
          id: userData._id,
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-24 pb-20">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <h1 className="text-3xl font-bold text-[#001F5B] mb-10 text-center">
            Contact Support
          </h1>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {/* Error Message */}
            {error && (
              <div className="mb-6 p-4 bg-red-100 text-red-600 rounded-xl text-center font-medium">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <textarea
                ...
                onChange={(e) => setMessage(e.target.value)}
                rows="6"
                className="w-full px-5 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E30613] resize-none"
              />

              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#E30613] hover:bg-[#c20511] text-white font-semibold py-3 rounded-xl transition"
              >
